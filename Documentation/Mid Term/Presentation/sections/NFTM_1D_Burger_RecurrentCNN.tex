...
\small
\textcolor{red_unipd}{\Large CNN Controller Architecture}
...
\begin{secframe}
  ...
  \small
\textcolor{red_unipd}{\Large NFTM with recurrent CNN architecture}
\begin{figure}[h]
\centering
% \begin{tikzpicture}[
...
\draw[->] (loss.east) -- ++(20mm,0) -- ++(0,109mm) -- (cnn1.east);
