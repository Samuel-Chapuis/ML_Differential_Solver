...
\begin{frame}{1D Burger Equation Datasets}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/burger/Heatmap_1DBurgers_visc_001.png} % viscosity = 0.01
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/burger/Heatmap_1DBurgers_visc_0001.png} % viscosity = 0.001
    \end{minipage}

    % Row 2
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/burger/Heatmap_1DBurgers_visc_01.png} % viscosity = 0.1
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/burger/Heatmap_1DBurgers_visc_05.png} % viscosity = 0.5
    \end{minipage}
\end{frame}
