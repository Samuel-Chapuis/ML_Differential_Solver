...
In this chapter, we present two distinct Neural Field Turing Machine (NFTM) models, developed as simulators for the 1D Burger's equation. Currently, these approaches are defined for the simulation of Burger's dynamics. The first model \textbf{................EXPLAIN SAMUEL'S MODEL: TRANSFORMER ................}. The second approach, corresponds to a Causal Temporal Convolutional Attention Network (TCAN) that enhances temporal modeling capabilities. While focused on the 1D Burgers' equation, the underlying frameworks are designed for future extension to general partial differential equations (PDEs).\\
We detail the architecture, training procedures, and evaluation metrics for both models, highlighting their respective strengths and limitations. 
