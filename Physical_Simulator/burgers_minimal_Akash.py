...
if __name__ == "__main__":
    # Your data loading
    project_root = Path(__file__).parent.parent
    train_data_dir = project_root / "saved_dataset" / "new_dataset_1D_Burgers" / "train"
    test_data_dir = project_root / "saved_dataset" / "new_dataset_1D_Burgers" / "test"
    ...
    plot_epoch_losses(history, project_root/"saved_results/new_dataset_results/losses_over_epochs.png")
